      ...
      <div
        ...
        <div
          ...
          <header>
            ...
            {post?.category && (
              <div
                className={`flex mb-1 items-center ${showPreview ? 'justify-center' : 'justify-start'} hidden md:block flex-wrap dark:text-gray-300 text-gray-600 hover:text-purple-600 dark:hover:text-purple-400`}>
                <SmartLink
                  passHref
            ...
            <SmartLink
              ...
              passHref
              className={
                ' group-hover:text-purple-600 dark:hover:text-purple-400 dark:group-hover:text-purple-300 text-black dark:text-gray-100  line-clamp-2 replace cursor-pointer text-xl font-extrabold leading-tight'
              }>
