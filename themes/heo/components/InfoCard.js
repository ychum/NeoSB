...
export function InfoCard(props) {
  ...
  return (
    <Card className='wow fadeInUp bg-[#7c3aed] dark:bg-purple-800 text-white flex flex-col w-72 overflow-hidden relative'>
      {/* 信息卡牌第一行 */}
      ...
      <div className='flex justify-between'>
        <div className='flex space-x-3  hover:text-black dark:hover:text-white'>
          {/* 两个社交按钮 */}
          {url1 && (
            <div className='w-10 text-center bg-purple-600 p-2 rounded-full  transition-colors duration-200 dark:bg-purple-700 dark:hover:bg-purple-900 hover:bg-purple-500'>
              <SmartLink href={url1}>
                <i className={icon1} />
              </SmartLink>
            </div>
...
function MoreButton() {
  ...
  return (
    <SmartLink href={url3}>
      <div
        className={
          'group bg-purple-600 dark:bg-purple-700 hover:bg-purple-500 dark:hover:bg-purple-900 hover:text-white flex items-center transition-colors duration-200 py-2 px-3 rounded-full space-x-1'
        }>
        <ArrowRightCircle
          className={
...
function GreetingsWords() {
  ...
  return (
    <div
      ...
      className=' select-none cursor-pointer py-1 px-2 bg-purple-600 hover:bg-purple-500  hover:text-white dark:bg-purple-700 dark:hover:text-white dark:hover:bg-purple-900 text-sm rounded-lg  duration-200 transition-colors'>
      {greeting}
    </div>
  )
}
