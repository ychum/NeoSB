            ...
            {post.category && (
              <>
                <SmartLink
                  ...
                  passHref
                  legacyBehavior>
                  <div className='cursor-pointer font-sm font-bold px-3 py-1 rounded-lg  hover:bg-purple-400 text-white bg-purple-600 dark:bg-purple-700 hover:text-white duration-200 '>
                    {post.category}
                  </div>
                </SmartLink>
              </>
